...
//FIXME - no events for policy adding/removing; need to implement that.
		...
		model.addPolicyModel(new ScoreBoardAlwaysShowJamPolicy());
		model.addPolicyModel(new ScoreBoardAdControlPolicy());
		model.addPolicyModel(new ShowElapsedPeriodTimeControlPolicy());
	...
	public class ScoreBoardAlwaysShowJamPolicy extends DefaultPolicyModel
	{
		public ScoreBoardAlwaysShowJamPolicy() {
			super("scoreboard.html AlwaysShowJamPolicy");
			setName(getId());

			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, SHOW_JAM, "Boolean", "false"));
		}
		public static final String SHOW_JAM = "Show Jam";
	}
	public class ScoreBoardHtmlIntermissionNamePolicy extends AbstractClockNumberChangePolicy
	{
		public ScoreBoardHtmlIntermissionNamePolicy() {
			...
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, CONFIRMED_NAME, "Boolean", "false"));
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, HIDE_TIME_AFTER_BOUT_NAME, "Boolean", "true"));
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, SHOW_TIME_NAME, "Boolean", "true"));
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, INTERMISSION_1_NAME, "String", "Halftime"));
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, INTERMISSION_1_CONFIRMED_NAME, "String", "Halftime"));
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, INTERMISSION_2_NAME, "String", "Unofficial Final"));
			addParameterModel(new DefaultPolicyModel.DefaultParameterModel(this, INTERMISSION_2_CONFIRMED_NAME, "String", "Final"));
			...
			final PolicyParameterEventVisitor ppeV = new DefaultPolicyParameterEventVisitor() {
					public void policyParameterValueChange(Policy.Parameter parameter, String value) {
						synchronized (changeLock) {
							updateIntermissionName(scoreBoardModel.getClock(Clock.ID_INTERMISSION).getNumber());
						}
					}
				};
			...
			getParameter(CONFIRMED_NAME).addPolicyParameterListener(listener);
			getParameter(INTERMISSION_1_NAME).addPolicyParameterListener(listener);
			getParameter(INTERMISSION_1_CONFIRMED_NAME).addPolicyParameterListener(listener);
			getParameter(INTERMISSION_2_NAME).addPolicyParameterListener(listener);
			getParameter(INTERMISSION_2_CONFIRMED_NAME).addPolicyParameterListener(listener);
		...
		public void clockNumberChange(Clock clock, int number) {
			getParameterModel(CONFIRMED_NAME).setValue("false");
			if ((number == 2) && Boolean.parseBoolean(getParameter(HIDE_TIME_AFTER_BOUT_NAME).getValue()))
				getParameterModel(SHOW_TIME_NAME).setValue("false");
			updateIntermissionName(number);
		}

		protected void updateIntermissionName(int number) {
			boolean confirmed = Boolean.parseBoolean(getParameter(CONFIRMED_NAME).getValue());
			Document doc = editor.createDocument("ScoreBoard");
			Element sb = editor.getElement(doc.getDocumentElement(), "ScoreBoard");
			Element page = editor.addElement(sb, "Page", "scoreboard.html");
			String name;
			switch (number) {
			case 1: name = getParameter(confirmed?INTERMISSION_1_CONFIRMED_NAME:INTERMISSION_1_NAME).getValue(); break;
			case 2: name = getParameter(confirmed?INTERMISSION_2_CONFIRMED_NAME:INTERMISSION_2_NAME).getValue(); break;
		...
		public static final String HIDE_TIME_AFTER_BOUT_NAME = "HideTimeAfterBout";
		public static final String SHOW_TIME_NAME = "ShowTime";
		public static final String INTERMISSION_1_NAME = "Intermission1";
		public static final String INTERMISSION_1_CONFIRMED_NAME = "Intermission1Confirmed";
		public static final String INTERMISSION_2_NAME = "Intermission2";
		public static final String INTERMISSION_2_CONFIRMED_NAME = "Intermission2Confirmed";
		public static final String INTERMISSION_OTHER_NAME = "IntermissionOther";
	}
	public class ShowElapsedPeriodTimeControlPolicy extends DefaultPolicyModel
	{
		public ShowElapsedPeriodTimeControlPolicy() {
			super("one-operator.html ShowElapsedPeriodTimeControlPolicy");
			setName(getId());
			setEnabled(false);
		}
	}
